(function (root) {
  ...
  const projectExtras = [
    ...
    ['flashcards-studio', 'Flashcards Studio', 'Offline spaced-repetition flashcards with SM-2 algorithm, zero server.', 'projects/flashcards-studio/index.html', '🗂️', 'tools', ['PWA', 'Offline']],
    ['focus-lens-privacy-dashboard', 'Focus Lens — Privacy Dashboard', 'Privacy dashboard for controlling data, microphone, notifications, and cookies.', 'projects/focus-lens-privacy-dashboard/index.html', '🔒', 'tools', ['Privacy', 'PWA']],
    ['hourly-wellness-widget', 'Hourly Wellness', '60-second breathing break every hour to recharge focus and build daily streaks.', 'projects/hourly-wellness-widget/index.html', '🧘', 'tools', ['Health', 'PWA']],
    ['offline-editor-studio', 'Offline Editor Studio', 'Local code editor with themes, bookmarks, and file management, zero server.', 'projects/offline-editor-studio/index.html', '📝', 'tools', ['Editor', 'Offline']],
    ['offline-library', 'Offline Library', 'Local .txt/.md file reader with bookmarks, runs entirely offline with no server.', 'projects/offline-library/index.html', '📚', 'tools', ['Reader', 'Offline']],
    ['privacy-audit', 'Privacy Audit', 'Audits local cookies, IndexedDB, localStorage, and notifications with export.', 'projects/privacy-audit/index.html', '🔍', 'tools', ['Privacy', 'PWA']],
    ['puzzle-scale', 'Scale Puzzle', 'Procedural pattern-matching puzzle with scalable levels, undo, and stats.', 'projects/puzzle-scale/index.html', '🧩', 'puzzle', ['Puzzle', 'PWA']],
    ['silent-journal', 'Silent Journal', 'Private journal with AES-256 local encryption, no server, no account needed.', 'projects/silent-journal/index.html', '📓', 'tools', ['Privacy', 'Offline']],
    ['silent-voice-reader', 'Silent Voice Reader', 'Silent vocal reading tool with local voice synthesis, privacy-first approach.', 'projects/silent-voice-reader/index.html', '🗣️', 'accessibility', ['Accessibility', 'Privacy']],
  ...
  const games = [    ['esposta', 'Esposta', 'Dalla camera oscura all\'agenzia digitale: impara fotografia, social media e marketing attraverso l\'archivio di Nonna Olga. 12 capitoli in 3 atti, 12 minigiochi veri, casi reali (Oreo, Taffo, Ferragni, Nike...), citazioni accademiche (Barthes, Sontag, Cialdini, Kotler, Ogilvy) e L\'Agenzia Infinita. PWA installabile.', 'games/esposta/index.html', '📸', 'educational', ['PWA', 'Story', 'Photography', 'iPhone'], true],
    ...
    ['wikithriving', 'WikiThriving', 'The Field Guide to Your Life — Duolingo della vita. 18 realms (Character, Learning, Math, Money, Health, Communication, Work, World, Practical, Purpose + Art, Science, Psychology, Music, Film, Design, Literature, Travel), 325+ lessons, 195 quotes, 180+ countries, 32 books, 25 poems, math trainers, calculators, progressione gamificata. PWA offline.', 'games/wikithriving/site/index.html', '📖', 'educational', ['PWA', 'Offline', 'Life Skills', 'iPhone'], true],
    ['quotesmith', 'QuoteSmith', 'Bilingual quote quiz with 1000+ quotes across 22 categories (film, books, science, poetry, love...), fully offline.', 'games/quotesmith/', 'Q', 'quiz', ['Offline', 'PWA', 'iPhone'], true],
    ...
    ['steel-waves', 'Steel Waves — Battaglia Navale', 'Clone arcade in stile World of Warships (top-down, Canvas 2D, zero librerie): 12 navi sbloccabili con cannoni, siluri, contraerea e speciali unici, 8 livree, potenziamenti permanenti e 3 modalità — Onde infinite (boss ogni 5), Sfida del Leviatano (boss su boss con scafo riparato) e Battaglia 5 vs 5 (4 alleati AI). Nemici con livree casuali e unità elite ✦, critici, homing, particelle, suoni sintetizzati. Ottimizzato per iPhone (joystick, touch, safe-area, auto-pausa). UI in italiano.', 'games/steel_waves.html', '⚓', 'arcade', ['2D', 'Navale', 'Arcade', 'iPhone'], true],
    ...
    ['miraggio-hotel', 'Miraggio Hotel', 'Un mini-hotel sociale in stile Habbo, colorato e simpatico: crea il tuo look, esplora 9 stanze (incluse la tua camera con negozio mobili e produzione di monete, la Terrazza delle stelle e la Cucina), parla con 12 ospiti con carattere che amano certe emote e custodiscono storie segrete (sblocca i loro segreti e i trofei), completa 3 missioni giornaliere, gioca a 4 minigiochi (Memoria, Whack-a-Tino, Jackpot, Caccia al tesoro), eventi a orari (Spritz alle 12, Festa alle 21) con monete doppie, ospite del giorno, livelli giocatore con sconti, diario di viaggio, album di figurine, tocca gli oggetti luccicanti per easter egg e 🪙 monete, rifatti il look nel guardaroba e colleziona distintivi (fino a Leggenda vivente). Auto-save, nessuna libreria, ottimizzato per iPhone.', 'games/miraggio-hotel/index.html', '🏨', 'games', ['Social', 'Canvas', 'iPhone'], true],
    ['stanza9', 'STANZA 9 — L\'albergo dei ricordi', 'RPG narrativo moderno (Baldur\'s Gate × Habbo Hotel): 7 giorni, luglio 2025. Un\'amica morta dieci anni fa riscrive dal server che sta per essere spento; una città che ha scelto di dimenticare; cinque ex-amici con cinque versioni della stessa notte. Cammina per le stanze (tap-to-move), parla, ricostruisci 12 ricordi, scegli tra 4 finali. Fiducia, frammenti, chat di gruppo, lettere e la Stanza 9 che si riempie mentre ricordi. Auto-save, ottimizzato per iPhone.', 'games/stanza9/index.html', '🛎️', 'story', ['Story', 'RPG', 'Choice', 'iPhone'], true],
    ...
    ['scarlius', 'Scarlius — Free Beer Party', 'Avventura grafica punta-e-clicca (stile Monkey Island) in una notte folle allo Scarlius, ottimizzata iPhone 9:16 con tap a una mano e inventario a comparsa. Raccogli 5 bicchieri per Thomas e ottieni la Chiave del Bagno, vinci il Flair Master di Luca per lo Scarlius Inferno, sveglia Davide con il cocktail e fai 3 canestri di fila per i Fusti, poi sincronizza le onde del deck di Ercole per il leggendario FREE BEER PARTY alla Playa. 3 minigiochi touch, dialoghi a scelta multipla IT/EN, auto-save, PWA offline (Phaser 3 vendored, zero asset: personaggi disegnati proceduralmente).', 'games/scarlius/index.html', '🍺', 'games', ['Story', 'Phaser', 'PWA', 'iPhone'], true],
    ['scalpel', 'Scalpel — Surgical Stories', 'Trauma Center-inspired PWA surgery game. 5 chapters, 8 surgical instruments, touch controls optimized for iPhone. Perform life-saving operations at Ospedale Miraggio: appendectomy, foreign body extraction, cardiac defibrillation, brain tumor laser resection, and mass-casualty triage. Scientific medical facts after every procedure. Canvas 2D, offline PWA.', 'games/scalpel/index.html', '🩺', 'simulation', ['PWA', 'Story', 'iPhone', 'Canvas', 'Offline'], true],
    ['votopoli', 'Votopoli — La Democrazia è un Gioco', 'Multiplayer voting simulator: gestisci business, vota sindaci satirici, corrompi politici e scala da una tenda a un castello! 20 paesi, 40 città, 13 business idle, 5 minigiochi, elezioni giornaliere e settimanali, mappa mondo SVG, PeerJS multiplayer.', 'games/votopoli/index.html', '🗳️', 'multiplayer', ['PeerJS', 'PWA', 'Idle', 'Multiplayer'], false],
    ['mystic-quest', 'Mystic Quest — Sky Herd Rescue', 'Navigate 5 realms, collect stars, free spirits, and restore the celestial dawn.', 'games/mystic-quest.html', '✨', 'arcade', ['Adventure', 'RPG'], false],
    ['scalpel-2', 'Scalpel 2', 'Surgery simulation game with story mode, daily challenges, and multiple game modes.', 'games/scalpel-2/index.html', '🩺', 'simulation', ['Story', 'Canvas', 'PWA'], false],
    ['voidbound', 'VOIDBOUND — Rites of the Rift', '5v5 MOBA arena set in a grimdark space universe, fight the Fauci of the Aether.', 'games/voidbound/index.html', '🌀', 'multiplayer', ['MOBA', '3D', 'PWA'], false],
    ['precision-skating', 'Precision Skating', 'Coach a 16-skater precision roller skating team: rhythm gameplay, tap drifting skaters, build formations to music.', 'games/precision-skating-game/index.html', '⛸️', 'simulation', ['Rhythm', 'Touch', 'PWA', 'Bilingual'], false]].map(([id,title,description,href,icon,category,badges,featured]) => ({ id, title, description, href, icon, category, badges, technologies: badges, featured, status: 'live', type: 'game', requirements: badges.includes('Camera') ? ['camera'] : [] }));

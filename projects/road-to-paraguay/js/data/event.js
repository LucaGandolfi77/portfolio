/**
 * event.js — L'IDENTITÀ DELL'EVENTO, IN UN UNICO POSTO.
 *
 * Qui stanno tutto ciò che riguarda la competizione: nomi, luogo, date e le frasi
 * chiave del gran finale. Modifica qui e si aggiorna in tutta l'app (header,
 * countdown, casella del 17, celebrazione, footer, titolo della pagina).
 *
...
/** Il nome dell'app. */
export const APP_NAME = 'Road to Paraguay';
